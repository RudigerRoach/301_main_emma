 ...
 * @author Endzeit
 */
public class YourateServerTest extends TestCase {
    
    private static YourateServer server = null;
    
    public YourateServerTest(String testName) throws Exception {
        super(testName);
    }
...
//		        "imgPath": "path/to/image.jpg" //the path where the image resides on the server
        ...
        assertEquals("Start of session failed",jsonTest.toString(),asyncResponse);
    }
